...
function renderEvent(e) {
  ...
  switch (e.ev) {
    ...
    case "scan": return `<span class="warn2">${esc(t)} Scan complete — ${e.total ?? "?"} videos, ${e.pending ?? "?"} pending${e.renamed ? `, ${e.renamed} renamed` : ""}${e.credited ? `, ${e.credited} credited from local additions` : ""}</span>`;
